 ...
 * Date: 2018-11-28
 * Description: This program reads records from a file into a vector of 
 * PersonInfo objects. Then it reformats the records and writes it to an
 * ostringstream then the standard output. */
#include <iostream>
#include <fstream>
#include <sstream>
#include <vector>
